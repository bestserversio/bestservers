        ...
        <Formik
            ...
            onSubmit={(values) => {
                ...
                addOrUpdateMut.mutate({
                    id: spy?.id,
                    host: values.host,
                    verbose: typeof verbose !== "undefined" ? Number(verbose) : undefined,
                    apiTimeout: typeof apiTimeout !== "undefined" ? Number(apiTimeout) : undefined,
                    vmsEnabled: vmsEnabled,
                    vmsKey: vmsKey,
                    vmsTimeout: typeof vmsTimeout !== "undefined" ? Number(vmsTimeout) : undefined,
                    vmsLimit: typeof vmsLimit !== "undefined" ? Number(vmsLimit) : undefined,
                    vmsMinWait: typeof vmsMinWait !== "undefined" ? Number(vmsMinWait) : undefined,
                    vmsMaxWait: typeof vmsMaxWait !== "undefined" ? Number(vmsMaxWait) : undefined,
